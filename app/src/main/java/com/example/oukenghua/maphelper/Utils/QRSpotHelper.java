...
public class QRSpotHelper {
    ...
    private static final int CHECK_PHOTO = 300;

    private static final int HANDLER_START = 301;
    private static final int HANDLER_SUCCESS = 302;
    private static final int HANDLER_ERROR = 303;
